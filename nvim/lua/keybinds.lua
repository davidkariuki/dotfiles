...
map("n", "<A-g>", "<cmd>Lspsaga open_floaterm lazygit<CR>", { noremap = true, silent = true })
map("n", "<A-t>", "<cmd>Lspsaga open_floaterm<CR>", { noremap = true, silent = true })
map("t", "<A-t>", "<C-\\><C-n><cmd>Lspsaga close_floaterm<CR>", { noremap = true, silent = true })
map("t", "<A-g>", "<C-\\><C-n><cmd>Lspsaga close_floaterm<CR>", { noremap = true, silent = true })
